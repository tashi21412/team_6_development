 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "USERS" ;
   ...
   CREATE SEQUENCE  "WZHONG21"."FORMIDSEQUENCE"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 35 NOCACHE  ORDER  NOCYCLE  NOPARTITION ;
