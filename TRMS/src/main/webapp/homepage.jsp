...
<form action="FormServlet" method="post" class="w3-container">
     ...
     <input class="w3-input w3-border w3-light-grey" type="date" placeholder = "$" id="eventDate" name="eventDate">



     <label for="eventTime" class="w3-text-teal" ><b>Event Time</b></label>

     <input class="w3-input w3-border w3-light-grey" type="time" placeholder = "$" id="eventTime" name="eventTime">



     <label for="location" class="w3-text-teal" ><b>Location</b></label>

     <input class="w3-input w3-border w3-light-grey" type="location" placeholder = "location" id="location" name="location">
     ...
     <label for="cost" class="w3-text-teal" ><b>Cost</b></label>

     <input class="w3-input w3-border w3-light-grey" type="text" placeholder = "$" id="cost" name="cost">



     <label for="description" class="w3-text-teal"><b>Event Description</b></label>

     <input class="w3-input w3-border w3-light-grey" type="text" placeholder = "Description" id="description" name="description">



     <label for="justification" class="w3-text-teal" style ="height:200px"><b>Justification</b></label>

     <input class="w3-input w3-border w3-light-grey" type="text" placeholder = "Reason To Participate" id="justification" name="justification">



     <label for="gradingFormat" class="w3-text-teal" ><b>Grading Format</b></label>

     <select class="w3-select" id="gradingFormat" name="gradingFormat">
     ...
     <label for="eventType" class="w3-text-teal" ><b>Type of Event</b></label>

     <select class="w3-select" id="eventType" name="eventType">

       <option value="" disabled selected>Choose your option</option>

       <option value="University Cours">University Course</option>
